...
export default async function ProfessionalExperience({ experienceId }: Props) {
	const experienceData = await getData('professional', experienceId)
		...
		<main className=' mx-auto mt-20 max-w-xl px-6 md:mt-14 md:max-w-7xl'>
			<Container>
				<header className='mb-10 max-w-2xl'>
					<HeadingContainer
						headingText={experienceData.company}
						paragraphText={experienceData.role}
					/>
				</header>
